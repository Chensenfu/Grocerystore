(function(root,factory,plugName){
	...
	Go.prototype = {
		...
		init:function(){
			...
			var dom = '<div class="GoTop-box" style="width:'+this.width+';height:'+this.height+';display:none;position:fixed;right:120px;'+sate+'"><img src='+this.url+' style="width:100%"></div>'
			$('body').append(dom);
